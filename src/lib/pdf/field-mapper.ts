...
const MICA_SECTION_MAPPINGS: MiCASectionMapping[] = [
  ...
  {
    sectionNumbers: ['H.1', 'H.3'],
    fieldNames: ['Blockchain Description', 'Blockchain description', 'Distributed ledger technology', 'Distributed ledger technology (DLT)'],
    patterns: [/blockchain\s*(?:description|technology)|DLT|Chiliz\s*Chain/i],
  ...
  {
    sectionNumbers: ['H.2', 'H.7'],
    fieldNames: ['Smart Contract', 'Smart contract', 'DLT functionality', 'DLT functionality description', 'Contract address'],
    patterns: [/smart\s*contract|DLT\s*functionality|contract\s*address/i],
    targetPath: 'partH.smartContractInfo',
    transform: extractSmartContractInfo,
    multiLine: true,
    confidence: 'medium',
  },
  {
